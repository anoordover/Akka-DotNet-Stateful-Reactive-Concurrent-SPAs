...
namespace Game.ActorModel.Actors
{
    public class SignalRBridgeActor : ReceiveActor
    {
        ...
        public SignalRBridgeActor(IGameEventsPusher gameEventPusher, IActorRef gameController)
        {
            ...
            Receive<PlayerStatusMessage>(message => _gameEventPusher.PlayerJoined(message.PlayerName, message.Health));
            Receive<PlayerHealthChangedMessage>(message => _gameEventPusher.UpdatePlayerHealth(message.PlayerName, message.Health));
        }
    }
}
